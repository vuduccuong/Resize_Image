...
module.exports = async function (_, env) {
  ...
  const componentStyleDirs = [
    ...
    path.join(__dirname, 'public/codecs'),
    path.join(__dirname, 'public/custom-els'),
  ...
  return {
    ...
    entry: {
      'first-interaction': './public/index'
    },
    ...
    resolve: {
      ...
      alias: {
        style: path.join(__dirname, 'public/style')
      }
    },
    resolveLoader: {
      alias: {
    ...
    module: {
      ...
      rules: [
        ...
        },
        {
          ...
          test: /\.js$/,
          include: path.join(__dirname, 'public/codecs'),
    ...
    plugins: [
      ...
      new HtmlPlugin({
        ...
        template: isProd ? '!!prerender-loader?string!public/index.html' : 'public/index.html',
        minify: isProd && {
